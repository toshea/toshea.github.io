...
(function($) {
  $.fn.amazingslider = function(options) {
    ...
    AmazingSlider.prototype = {
        ...
        $(".amazingslider-slides", this.container).find("li").each(function() {
          ...
          if (img.length > 0) {
            ...
            var texteffect = img.data("texteffect") &&
              img.data("texteffect").length > 0 ? img.data("texteffect") : "";
            ...
            var elem = new Array(instance.elemArray.length,
              src, title, description, link, target, video, "", lightbox, lightboxwidth, lightboxheight, dataWebm, dataOgg, texteffect, duration);
      ...
      createMarkup: function() {
        this.$wrapper = jQuery("" + "<div class='amazingslider-wrapper-" + this.id + "'>" + "<div class='amazingslider-background-image-" + this.id + "'></div>" + "<div class='amazingslider-bottom-shadow-" + this.id + "'></div>" + "<div class='amazingslider-slider-" + this.id + "'>" + "<div class='amazingslider-box-" + this.id + "'>" + "<div class='amazingslider-swipe-box-" +
          this.id + "'>" + "<div class='amazingslider-space-" + this.id + "'></div>" + "<div class='amazingslider-img-box-" + this.id + "'></div>" + "<div class='amazingslider-lightbox-play-" + this.id + "'></div>" + "</div>" + "</div>" + "<div class='amazingslider-text-box-" + this.id + "'></div>" + "<div class='amazingslider-play-" + this.id + "'></div>" + "<div class='amazingslider-video-wrapper-" + this.id + "'></div>" + "<div class='amazingslider-ribbon-" + this.id + "'></div>" + "<div class='amazingslider-arrow-left-" + this.id + "'></div>" + "<div class='amazingslider-arrow-right-" +
      ...
      createText: function() {
        ...
        this.container.bind("amazingslider.switchtext", function(event, prev, cur) {
          $("head").find("style").each(function() {
            if ($(this).data("creator") == "amazingslidercreator" && $(this).data("csstype") == "texteffect") $(this).remove()
          });
          var textHeadCss = "<style type='text/css' data-creator='amazingslidercreator' data-csstype='texteffect'>" + ".amazingslider-text-" + instance.id + " {" + instance.textoptions.textcss + "} " + ".amazingslider-text-bg-" + instance.id + " {" +
            instance.textoptions.textbgcss + "} " + ".amazingslider-title-" + instance.id + " {" + instance.textoptions.titlecss + "} " + ".amazingslider-description-" + instance.id + " {" + instance.textoptions.descriptioncss + "} ";
          ...
          if (instance.textoptions.textstyle == "static") {
            ...
            if (!instance.textoptions.textautohide) $textWrapper.css({
              display: "block"
            });
            else if (instance.prevtextstyle != "static") $textWrapper.css({
      ...
      createStyle: function() {
        ...
        if (this.options.borderradius >
          0) styleCss += "border-radius:" + this.options.borderradius + "px;-moz-border-radius:" + this.options.borderradius + "px;-webkit-border-radius:" + this.options.borderradius + "px;";
        if (this.options.showshadow) {
          var b = "0px 0px " + this.options.shadowsize + "px " + this.options.shadowcolor;
          styleCss += "box-shadow:" + b + ";-moz-box-shadow:" + b + ";-webkit-box-shadow:" + b + ";";
          if (ASPlatforms.isIE678() || ASPlatforms.isIE9) styleCss += "filter:progid:DXImageTransform.Microsoft.Shadow(color=" + this.options.shadowcolor + ",direction=135,strength=" +
      ...
      createNav: function() {
        ...
        if (this.options.navstyle ==
          "thumbnails" && this.options.navshowfeaturedarrow) {
        ...
        if (this.options.navstyle !=
          ...
          if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
            ...
            $navContainer.height() || instance.options.navdirection == "horizontal" && $bulletWrapper.width() > $navContainer.width()) {
            ...
            $carLeftArrow.click(function() {
              if (instance.options.navdirection ==
                "vertical") instance.carMoveBottom();
          ...
          if (this.options.navshowpreview) {
            var $preview = $("<div class='amazingslider-nav-preview-" + this.id + "' style='display:none;position:absolute;width:" + this.options.navpreviewwidth + "px;height:" + this.options.navpreviewheight + "px;background-color:" + this.options.navpreviewbordercolor + ";padding:" + instance.options.navpreviewborder +
              "px;'></div>");
        ...
        if (this.options.navstyle == "bullets") {
          ...
          $(imgLoader).load(function() {
            if (instance.options.navthumbstyle != "textonly") {
              ...
              else style = "max-width:none !important;width:auto;height:100%;margin-left:-" + Math.floor(this.width / this.height *
                instance.options.navimageheight / 2 - instance.options.navimagewidth / 2) + "px";
            ...
            if (instance.options.navthumbstyle != "imageonly") {
              ...
              else if (instance.options.navthumbstyle == "imageandtitledescription") thumbtitle += "margin-left:" + instance.options.navimagewidth + "px;margin-top:0px;width:" + instance.options.navthumbtitlewidth + "px;height:" + instance.options.navimageheight +
                "px;";
              ...
              if (instance.options.navthumbstyle == "imageandtitledescription" || instance.options.navthumbstyle == "textonly") thumbtitle += "<div class='amazingslider-nav-thumbnail-description-" +
      ...
      showImage: function(slideDirection) {
        ...
        $(imgLoader).load(function() {
          ...
          var imgCurCodes = "<div class='amazingslider-img-" + instance.id +
          ...
          if (sliderRatio < imgRatio)
            if (instance.options.scalemode == "fit") {
              instance.curImageMaxWidth = sliderRatio / imgRatio *
                100;
          ...
          } if (Math.abs(instance.curImageMarginLeft) > 0) imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:100%;left:0%;top:0%;margin-left:" +
    ...
    this.each(function() {
      ...
      if ($(this).data("skin") && typeof AMAZINGSLIDER_SKIN_OPTIONS !==
        "undefined")
      ...
      if (this.options.versionmark != "AMC" + "om") {
        this.options.showwatermark = window.location.href.indexOf(this.options.fvm) >=
          0 ? false : true;
